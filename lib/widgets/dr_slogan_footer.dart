  ...
  Widget build(BuildContext context) {
    ...
    final String text = isWorld
      ? settings.translate(
        ...
        'یہ اوقات کیلکیولیشن میتھڈ کے مطابق ہیں، لہٰذا نماز کے اوقات میں تین منٹ کی احتیاط شامل کی جائے (دیے گئے اوقات سے تین منٹ بعد نمازیں اور افطار کیا جائے، جبکہ روزہ فجر کے وقت سے تین منٹ پہلے بند کیا جائے)',
        'هي وقت حسابي طريقي مطابق آهن، ان ڪري نماز جي وقتن ۾ ٽن منٽن جي احتياط شامل ڪئي وڃي (ڏنل وقتن کان ٽي منٽ پوءِ نماز ۽ افطار ڪيو وڃي، جڏهن ته روزو فجر جي وقت کان ٽي منٽ اڳ بند ڪيو وڃي)',
        'هذه الأوقات مبنية على طريقة الحساب، لذا يجب تضمين احتياط 3 دقائق في أوقات الصلاة (يجب أداء الصلاة والإفطار بعد 3 دقائق من الأوقات المحددة، بينما يجب الإمساك عن الطعام قبل 3 دقائق من وقت الفجر).'
      )
      : settings.translate(
