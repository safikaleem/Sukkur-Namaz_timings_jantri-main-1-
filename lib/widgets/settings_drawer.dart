              ...
              Column(
                ...
                children: [
                  ...
                  _buildNewFeatureItem(
                    ...
                    settings,
                    settings.translate(
                      'New Live Prayer Widgets',
                      'نئے لائیو نماز ویجٹس',
                      'نوان لائيو نماز ويجٽس',
                      'ويدجت صلاة حية جديدة',
                    ),
                    settings.translate(
                      'Added new vertical widgets to the home screen. These new widgets show your daily prayers with live countdown timings that update continuously, available in both Light and Dark modes.',
                      'ہوم اسکرین پر نئے عمودی ویجٹس شامل کیے گئے ہیں۔ یہ نئے ویجٹس لائیو کاؤنٹ ڈاؤن کے ساتھ آپ کی روزانہ کی نمازیں دکھاتے ہیں جو مسلسل اپ ڈیٹ ہوتے ہیں، اور لائٹ اور ڈارک دونوں موڈز میں دستیاب ہیں۔',
                      'هوم اسڪرين تي نوان عمودي ويجٽس شامل ڪيا ويا آهن. اهي نوان ويجٽس لائيو ڪائونٽ ڊائون سان گڏ توهان جي روزاني نمازون ڏيکارين ٿا جيڪي مسلسل اپ ڊيٽ ٿين ٿا، ۽ لائيٽ ۽ ڊارڪ ٻنهي موڊز ۾ موجود آهن.',
                      'تمت إضافة أدوات عمودية جديدة إلى الشاشة الرئيسية. تعرض هذه الأدوات الجديدة صلواتك اليومية مع أوقات عد تنازلي حية تتحدث باستمرار، وهي متاحة في الوضعين الفاتح والداكن.',
                    ),
                  ...
                  _buildNewFeatureItem(
                    ...
                    settings.translate(
                      'Fixed the widget image cropping issue, added the Gregorian date to widgets, and improved the 1-hour grace period logic for Ishraq and Zawal.',
                      'ویجٹ تصویر کٹنے کا مسئلہ حل کر دیا گیا، ویجٹس میں عیسوی تاریخ شامل کر دی گئی، اور اشراق اور زوال کے لیے 1 گھنٹے کے اضافی وقت کی لاجک کو بہتر بنایا گیا۔',
                      'ويجٽ تصوير ڪٽجڻ جو مسئلو حل ڪيو ويو، ويجٽس ۾ عيسوي تاريخ شامل ڪئي وئي، ۽ اشراق ۽ زوال لاءِ 1 ڪلاڪ جي واڌو وقت جي لاجڪ کي بهتر بڻايو ويو.',
                      'تم حل مشكلة اقتصاص صورة الودجة، وإضافة التاريخ الميلادي إلى الودجات، وتحسين منطق فترة السماح لمدة ساعة واحدة للإشراق والزوال.',
                    ),
